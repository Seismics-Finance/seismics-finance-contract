...
contract proxyOwner is multiSignatureClient{
    bytes32 private constant proxyOwnerPosition  = keccak256("org.seismics.Owner.storage");
    bytes32 private constant proxyOriginPosition0  = keccak256("org.seismics.Origin.storage.0");
    bytes32 private constant proxyOriginPosition1  = keccak256("org.seismics.Origin.storage.1");
    uint256 private constant oncePosition  = uint256(keccak256("org.seismics.Once.storage"));
